...
use App\Repository\TechnicalStatusRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: TechnicalStatusRepository::class)]
#[ORM\Table(name: 'technical_statuses')]
class TechnicalStatus
{
    ...
    #[ORM\Column(name: 'name', type: Types::STRING, length: 30)]
    private string $name;
