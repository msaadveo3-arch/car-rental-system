...
class VehicleModel
{
    ...
    #[ORM\ManyToOne(targetEntity: VehicleMake::class)]
    ...
    public function getMake(): VehicleMake { return $this->make; }
    public function setMake(VehicleMake $make): self { $this->make = $make; return $this; }
