...
export const COUNTRIES: Country[] = [
  ...
  { name: 'Belgium', code: 'BE' }, { name: 'Bosnia and Herzegovina', code: 'BA' }, { name: 'Brazil', code: 'BR' },
  { name: 'Bulgaria', code: 'BG' }, { name: 'Cambodia', code: 'KH' }, { name: 'Cameroon', code: 'CM' },
  { name: 'Canada', code: 'CA' }, { name: 'Chad', code: 'TD' }, { name: 'Chile', code: 'CL' },
  ...
  { name: 'Kuwait', code: 'KW' }, { name: 'Kyrgyzstan', code: 'KG' }, { name: 'Lebanon', code: 'LB' },
  { name: 'Libya', code: 'LY' }, { name: 'Luxembourg', code: 'LU' }, { name: 'Malaysia', code: 'MY' },
  { name: 'Maldives', code: 'MV' }, { name: 'Malta', code: 'MT' }, { name: 'Mauritius', code: 'MU' },
  { name: 'Mexico', code: 'MX' }, { name: 'Monaco', code: 'MC' }, { name: 'Mongolia', code: 'MN' },
  ...
  { name: 'Palestine', code: 'PS' }, { name: 'Philippines', code: 'PH' }, { name: 'Poland', code: 'PL' },
